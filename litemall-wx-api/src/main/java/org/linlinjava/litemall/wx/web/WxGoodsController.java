...
public class WxGoodsController {
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
        ...
        Callable<Object> goodsSpecificationListCallable = () -> goodsSpecificationService.queryByGid(id);
        ...
        FutureTask<Object> objectCallableTask = new FutureTask<>(goodsSpecificationListCallable);
...
//		executorService.submit(grouponRulesCallableTask);
        ...
        try {
            ...
            data.put("browseGoodsNumber",SystemConfig.getBrowse_goods_number());
            data.put("browseGoodsTime",SystemConfig.getBrowse_goods_time());
    ...
    public Object list(
            ...
            @Sort(accepts = {"add_time", "retail_price", "name","is_convert"}) @RequestParam(defaultValue = "add_time") String sort,
        ...
        //获取兑换区商品
        List<LitemallGoods> convertGoodsList = goodsService.queryByConvert(categoryId, keyword,1, SystemConfig.getConvertLimit());
        ...
        entity.put("convertGoodsList", convertGoodsList);
