...
public class WxOrderController {
     ...
     *
     * @param userId 用户ID
     * @param body   订单信息，{ orderId：xxx,money:xxx }
     * @return 支付订单ID
     */
    @PostMapping("prepay")
     ...
     */
    @PostMapping("entPay")
    public Object entPay(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        return wxOrderService.entPay(userId, body, request);
    }
