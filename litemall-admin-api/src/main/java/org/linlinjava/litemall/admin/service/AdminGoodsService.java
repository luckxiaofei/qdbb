...
public class AdminGoodsService {
    ...
    private Object validate(GoodsAllinone goodsAllinone) {
        ...
        for (LitemallGoodsSpecification specification : specifications) {
            ...
            String value = specification.getSpecification();
            if (StringUtils.isEmpty(value)) {
                return ResponseUtil.badArgument();
            }
        }
        ...
        for (LitemallGoodsProduct product : products) {
            ...
            String productSpecifications = product.getSpecification();
            if (StringUtil.isEmpty(productSpecifications)) {
                return ResponseUtil.badArgument();
            }
        }
    ...
    public Object update(GoodsAllinone goodsAllinone) {
        ...
        //将生成的分享图片地址写入数据库 todo 有点问题，有空再修复
...
//                specification.setValue(null);
        ...
        // 目前这些字段是goods_sn, goods_name, price, pic_url
        for (LitemallGoodsProduct product : products) {
            cartService.updateProduct(product.getId(), goods.getGoodsSn(), goods.getName(), goods.getRetailPrice(), product.getUrl());
        }
    ...
    public Object create(GoodsAllinone goodsAllinone) {
        ...
        for (LitemallGoodsSpecification specification : specifications) {
            ...
            Integer id = specificationService.add(specification);
        ...
        for (LitemallGoodsProduct product : products) {
            ...
            Integer specificationid = Arrays.stream(specifications)
                    .filter(p -> p.getSpecification().equals(product.getSpecification()))
                    .map(LitemallGoodsSpecification::getId)
                    .findFirst()
                    .orElse(null);
            product.setSpecificationid(specificationid);
