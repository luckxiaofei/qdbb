...
public class LitemallCartService {
    ...
    public LitemallCart queryExist(Integer goodsId, Integer specificationId, Integer userId) {
        ...
        example.or().andGoodsIdEqualTo(goodsId).andSpecificationIdEqualTo(specificationId).andUserIdEqualTo(userId).andDeletedEqualTo(false);
    ...
    public int delete(List<Integer> goodsIdList, int userId) {
        LitemallCartExample example = new LitemallCartExample();
        example.or().andUserIdEqualTo(userId).andGoodsIdIn(goodsIdList);
    ...
    public int updateCheck(Integer userId, List<Integer> goodsIdList, Boolean isChecked) {
        LitemallCartExample example = new LitemallCartExample();
        example.or().andUserIdEqualTo(userId).andGoodsIdIn(goodsIdList).andDeletedEqualTo(false);
    ...
    public void clearGoods(Integer userId, List<Integer> goodsIdList) {
        LitemallCartExample example = new LitemallCartExample();
        example.or().andUserIdEqualTo(userId).andCheckedEqualTo(true).andGoodsIdIn(goodsIdList);
        LitemallCart cart = new LitemallCart();
        cart.setDeleted(true);
        cartMapper.updateByExampleSelective(cart, example);
    }
